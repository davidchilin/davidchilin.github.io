          ...
          d3.csv("usgross_mapping.csv", function (error, usGross) {
            ...
            var scriptNest = d3
              ...
              .rollup(function (leaves) {
                ...
                if (mobile) {
                  var nonWhitePercent =
                    Math.round((100 * nonWhite_words) / total_words) / 100;
            ...
            function spectrumChart() {
                ...
                if (mobile == 1 && bucket == 0) {
                  var disneyElementsData = disneyElements
                    .filter(function (d, i) {
                      ...
                      return (
                        leftAssign(d.nonWhite_percent) == bucketElements[bucket]
                      );
                    })
                    .style("left", function (d) {
                      if (mobile) {
                      ...
                      return (
                        width * ((leftAssign(d.nonWhite_percent) - 1) / 3) +
                        10 +
                        "px"
                      );
                    })
                  ...
                  statContainer
                    ...
                    .html(function (d, i) {
                      ...
                      } else if (i == 0 && d.nonWhite_percent > 0.6666665) {
                        return (
                          percentFormat(d.nonWhite_percent) +
                          " nonwhite Dialogue"
                        );
                      } else if (i % 5 == 0 && d.nonWhite_percent < 0.33) {
                  ...
                  var disneyAxisBucket = disneyAxis
                    ...
                    .style("left", function (d) {
                      return (
                        (width * (bucketElements[bucket] - 1)) / 3 + 10 + "px"
                      );
                    })
              ...
              function stageOne() {
                ...
                var disneyExisting = filmElements.filter(function (d, i) {
                    ...
                    if (
                      ...
                      if (stage == 1) {
                        ...
                        markerBubble
                          ...
                          .style("left", function (d) {
                            return (
                              Math.floor(cx(exampleFilm.nonWhite_percent)) -
                              3 +
                              "px"
                            );
                          })
              ...
              function updateSpectrumSearch(data) {
                ...
                if (stage == 3) {
                  ...
                  markerFixed
                    .transition()
                    .duration(250)
                    .style("left", axisSize(data.nonWhite_percent) + "px");
                  previewNameContainerFixed
                    .transition()
                    .duration(250)
                    .style("left", axisSize(data.nonWhite_percent) + "px");
                  ...
                  previewData
                    .data([data.nonWhite_percent, 1 - data.nonWhite_percent])
                    .enter();
                  ...
                  if (mobile) {
                    markerBubble
                      ...
                      .style("opacity", 1);
                    markerBubble
                      .style("top", topPosition + markerBubbleTopOffset + "px")
                      .transition()
                      .duration(100)
                      .style("opacity", 1);
              ...
              function elementMouseover(element, data, item) {
                if (!mobile) {
                  ...
                  var topPosition = +d3
                    ...
                    .replace("px", "");
                  if (
                    +d3.select(element).style("width").replace("px", "") > 2
                  ) {
                    markerBubble
                      .style("left", leftPosition - 3 + "px")
                      .transition()
                ...
                function searchFilmColumn(value) {
                  if (value.length > 2) {
                    ...
                    var filteredSpectrumData = spectrumData.filter(
                      function (d, i) {
                        ...
                        if (genreSelected == "all" && stage == 3) {
                          ...
                          var substring = genreSelected;
                          return (
                            +d.gross > 45 && string.indexOf(substring) > -1
                          );
                        }
                        return string.indexOf(substring) > -1;
                      },
                    ...
                    var searchEnter = searchDivData
                      ...
                      .html(function (d) {
                        var final_str = d.title.replace(re, function (str) {
                          return "<b><u>" + str + "</u></b>";
                        });
                        var percent =
            ...
            function allFilms() {
                ...
                detailChartEnter
                  .on("mouseover", function (d, i) {
                    ...
                    detailToolTipRows = d3
                      .select(".all-films-detail-tool-tip-row-container")
                      .selectAll("div")
                ...
                detailChartDataTitle
                  ...
                  .text(function (d, i) {
                    if (d.title.length > detailChartDataTitleLength) {
                      return (
                        d.title.slice(0, detailChartDataTitleLength - 2) + "..."
                      );
                    }
                    return d.title;
                  })
              ...
              var detailNext = d3
                ...
                .on("click", function () {
                  ...
                  detailChartData = detailChartData.data(
                    filteredBucketData.slice(offsetAmount, offsetAmount + 19),
                    function (d, i) {
              ...
              if (filteredBucketData && filteredBucketData.length > 0) {
                ...
                // If no films are found, we can display a message (optional but good practice)
                detailChart.html(
                  "<p class='tk-futura-pt' style='padding: 20px;'>No films found for this selection.</p>",
                );
              }
              ...
              function distributionUpdate() {
                ...
                histogramThreeSpectrum = histogramThreeSpectrum.data(buckets);
              ...
              d3.selectAll(".filter-item-all").on("click", function (d, i) {
                offsetAmount = 0;
              ...
              d3.selectAll(".filter-item-era").on("click", function (d, i) {
                offsetAmount = 0;
            ...
            function ageHistogram() {
              ...
              for (var raceBucket in ageNest) {
                ...
                if (ageNest[raceBucket].key != "?") {
                  ...
                  for (var item in buckets) {
                    buckets[item].total = d3.sum(buckets[item], function (d) {
                      return d.values;
                    });
                  }
                  ...
                  var ageBar = ageDataHistogram
                    ...
                    .text(function (d, i) {
                      if (bucketsScale(d.total / totalSum) > 55) {
                        return (
                          commaFormat(Math.ceil((d.total / 1000000) * 10)) +
                          "M Words"
                        );
                      }
                      return null;
              ...
              var y = d3.scale.linear().domain([0, 0.1]).range([height, 0]);
