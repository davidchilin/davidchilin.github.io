...
function drawHistogram(){
  ...
  // d3.csv("master.csv", function(error, masterData) {
    d3.csv("davidchilin.github.io/genre_mapping.csv", function(error, genreMapping) {
      d3.csv("davidchilin.github.io/character_list7.csv", function(error, characterData) {
        d3.csv("davidchilin.github.io/metadata_7.csv", function(error, metaData) {
           d3.csv("davidchilin.github.io/DisneyFilms3.csv", function(error, disneyFilms) {
            d3.csv("davidchilin.github.io/usgross_mapping.csv", function(error, usGross) {
