...
function drawHistogram() {
  ...
  d3.csv(
    "davidchilin.github.io/genre_mapping.csv",
    function (error, genreMapping) {
      d3.csv(
        "davidchilin.github.io/character_list7.csv",
        function (error, characterData) {
          d3.csv(
            "davidchilin.github.io/metadata_7.csv",
            function (error, metaData) {
              d3.csv(
                "davidchilin.github.io/DisneyFilms3.csv",
                function (error, disneyFilms) {
                  d3.csv(
                    "davidchilin.github.io/usgross_mapping.csv",
                    function (error, usGross) {
                      ...
                      for (var race in ageNest) {
                        ...
                        for (var age in ageNest[race].values) {
                          ...
                          if (
                            +ageNest[race].values[age].key > 0 &&
                            +ageNest[race].values[age].key < 110 &&
                            +ageNest[race].values[age].key != ""
                          ) {
                            ...
                            raceSum =
                              ageNest[race].values[age].values + +raceSum;
                          }
                        }
                      ...
                      var scriptNest = d3
                        ...
                        .rollup(function (leaves) {
                          ...
                          if (mobile) {
                            var nonWhitePercent =
                              Math.round((100 * nonWhite_words) / total_words) /
                              100;
                            if ((nonWhitePercent * 100) % 2 != 0) {
                              nonWhitePercent = Math.round(
                                nonWhitePercent * 100,
                              );
                      ...
                      var interpolateTwo = d3.interpolate(
                        "#ddd",
                        nonWhiteColor,
                      );
                      ...
                      var colorScaleContinuous = d3.scale
                        .linear()
                        .domain([0, 0.25, 0.5, 1])
                        .range(["#fecb45", "#f9d475", "#ddd", nonWhiteColor]);
                      var bucketScale = d3.scale
                        .threshold()
                        .domain([0.2, 0.4, 0.6, 0.8, 1.1])
                        .range([
                          "bucket-a",
                          "bucket-b",
                          "bucket-c",
                      ...
                      for (item in movieData) {
                        var nonWhitePercentBucket =
                          movieData[item].nonWhite_percent;
                        if (nonWhitePercentBucket in nonWhitePercentOrder) {
                          nonWhitePercentOrder[nonWhitePercentBucket] =
                            nonWhitePercentOrder[nonWhitePercentBucket] + 1;
                        } else {
                          nonWhitePercentOrder[nonWhitePercentBucket] = 0;
                        }
                        movieData[item].yOrder =
                          nonWhitePercentOrder[nonWhitePercentBucket];
                      ...
                      function spectrumChart() {
                        ...
                        var randomScale = d3.scale
                          .linear()
                          .domain([0, 1])
                          .range([0, movieData.length]);
                        var spectrumData = [];
                        ...
                        if (mobile) {
                          var mobileSpectrumData = spectrumData.filter(
                            function (d, i) {
                          ...
                          filmElements
                            ...
                            .style("background-color", function (d) {
                              ...
                              var color = d3.rgb(
                                colorScaleContinuous(d.nonWhite_percent),
                              );
                              return color;
                            })
                            .style("width", "6px")
                        ...
                        var leftAssign = d3.scale
                          .threshold()
                          .domain([0.4, 0.6, 1])
                          .range([1, 2, 3]);
                        var disneyScalenonWhite = d3.scale
                          .linear()
                          .domain([0, 1])
                          .range(["#CCC", nonWhiteColor]);
                        var disneyScalewhite = d3.scale
                          .linear()
                          .domain([0, 1])
                          ...
                          if (mobile == 1 && bucket == 0) {
                            var disneyElementsData = disneyElements
                              ...
                              .style("left", function (d) {
                                ...
                                return (
                                  width *
                                    ((leftAssign(d.nonWhite_percent) - 1) / 3) +
                                  10 +
                                  "px"
                                );
                              })
                            ...
                            var barContainer = disneyElementsData
                              .append("div")
                              .attr(
                                "class",
                                "film-element-column-container tk-futura-pt",
                              );
                            var whiteBar = barContainer
                              .append("div")
                            ...
                            var nonWhiteBar = barContainer
                              .append("div")
                              .attr("class", "film-nonwhite-bar film-bar")
                              .style("background-color", function (d) {
                                return disneyScalenonWhite(d.nonWhite_percent);
                              });
                            var statContainer = disneyElementsData
                              .append("div")
                              .attr(
                                "class",
                                "film-stat-container tk-futura-pt",
                              );
                            statContainer
                              .append("div")
                              ...
                              .html(function (d, i) {
                                if (i == 0 && d.nonWhite_percent < 0.33) {
                                  return (
                                    percentFormat(1 - d.nonWhite_percent) +
                                    " white Dialogue"
                                  );
                                } else if (
                                  i == 0 &&
                                  d.nonWhite_percent > 0.6666665
                                ) {
                                  return (
                                    percentFormat(d.nonWhite_percent) +
                                    " nonwhite Dialogue"
                                  );
                                } else if (
                                  i % 5 == 0 &&
                                  d.nonWhite_percent < 0.33
                                ) {
                                  return percentFormat(1 - d.nonWhite_percent);
                                } else if (
                                  i % 5 == 0 &&
                                  d.nonWhite_percent > 0.66666665
                                ) {
                                  ...
                                  return (
                                    ...
                                    percentFormat(1 - d.nonWhite_percent) +
                                    "</span>/<span class='nonwhite-color'>" +
                                    percentFormat(d.nonWhite_percent) +
                                    "</span>"
                                  );
                                }
                            ...
                            var disneyAxisBucket = disneyAxis
                              .append("div")
                              .attr("class", "star-chart-disney-axis-bucket")
                              .style("left", function (d) {
                                return (
                                  (width * (bucketElements[bucket] - 1)) / 3 +
                                  10 +
                                  "px"
                                );
                              })
                            ...
                            disneyAxisBucket
                              ...
                              .attr(
                                "class",
                                "disney-mid-line-label tk-futura-pt",
                              )
                              .text("50/50");
                            ...
                            disneyAxisBucket
                              ...
                              .attr(
                                "class",
                                "disney-bucket-border tk-futura-pt",
                              );
                            ...
                            disneyAxisBucket
                              ...
                              .text(function (d) {
                                if (bucketElements[bucket] == 1) {
                                  return "Lighter-skinned actors have 60%+ Dialogue";
                                } else if (bucketElements[bucket] == 2) {
                                  return "Balanced Dialogue, +/- 10%";
                                }
                                return "Darker-skinned actors have 60%+ Dialogue";
                              });
                          }
                        ...
                        d3.selectAll(".histogram-two-big").on(
                          "click",
                          function () {
                            var stageId = d3.select(this).attr("id");

                            d3.selectAll(".histogram-two-big")
                              .style("color", null)
                              .style("fill", null)
                        ...
                        function stageOne() {
                          ...
                          histogramTwoAxis
                            ...
                            .style("opacity", null)
                            .style("visibility", "hidden");
                          d3.select(".histogram-two-script-container").style(
                            "visibility",
                            "hidden",
                          );
                          markerBubble
                          ...
                          filmElements = filmElements.data(
                            spectrumData,
                            function (d) {
                              return d.imdb_id;
                            },
                          ...
                          var disneyExisting = filmElements.filter(
                            function (d, i) {
                              return (
                                d3.select(this).attr("id") == "disney-cell"
                              );
                            },
                          );
                          ...
                          for (bucket in bucketElements) {
                            var disneyElementsMove = d3
                              .selectAll("#disney-cell")
                              .filter(function (d, i) {
                                return (
                                  leftAssign(d.nonWhite_percent) ==
                                  bucketElements[bucket]
                        ...
                        function stageTwo() {
                          ...
                          var filteredSpectrumData = spectrumData.filter(
                            function (d, i) {
                          ...
                          for (item in filteredSpectrumData) {
                            var nonWhitePercentBucket =
                              filteredSpectrumData[item].nonWhite_percent;
                            if (nonWhitePercentBucket in nonWhitePercentOrder) {
                              nonWhitePercentOrder[nonWhitePercentBucket] =
                                nonWhitePercentOrder[nonWhitePercentBucket] + 1;
                            } else {
                            ...
                            filteredSpectrumData[item].yOrder =
                              nonWhitePercentOrder[nonWhitePercentBucket];
                          }
                          ...
                          var filmElementsNew = filmElements
                            ...
                            .style("left", function (d) {
                              if (mobile) {
                                return (
                                  Math.round(cx(d.nonWhite_percent)) + "px"
                                );
                              }
                              return cx(d.nonWhite_percent) + "px";
                            })
                          ...
                          filmElements
                            ...
                            .style("left", function (d) {
                              if (mobile) {
                                return (
                                  Math.floor(cx(d.nonWhite_percent)) + "px"
                                );
                              }
                              return cx(d.nonWhite_percent) + "px";
                            })
                          ...
                          if (mobile) {
                            ...
                            whiteForty
                              ...
                              .delay(delayAmount)
                              .style("opacity")
                              .style("left", axisWidth * 0.4 + "px");
                            nonWhiteSixty
                              .transition()
                              .duration(durationAmount)
                              .delay(delayAmount)
                              .style("opacity", 1)
                              .style("left", axisWidth * 0.6 + "px");
                            whiteTen
                              .transition()
                              .duration(durationAmount)
                              .delay(delayAmount)
                        ...
                        function stageThree() {
                          ...
                          d3.select(".histogram-two-script-container")
                            .style("opacity", 0)
                            .style("visibility", "visible")
                            .transition()
                            .duration(1000)
                          ...
                          var filteredSpectrumData = spectrumData.filter(
                            function (d, i) {
                              ...
                              var substring = genreSelected;
                              return (
                                string.indexOf(substring) > -1 && +d.gross > 45
                              );
                            },
                          );
                          filmElements = filmElements.data(
                        ...
                        if (!mobile) {
                          var pinFirstChart = new ScrollMagic.Scene({
                            ...
                            .setPin(".star-chart-container", {
                              pushFollowers: false,
                            })
                            .addTo(controller);
                          var exitOnTop1000 = new ScrollMagic.Scene({
                            triggerElement: ".star-chart-container",
                            duration: 200,
                            triggerHook: 0,
                            offset: 200,
                          })
                              ...
                              if (
                                ...
                                if (stage == 1) {
                                  ...
                                  d3.selectAll("#disney-cell")
                                    ...
                                    .style("left", function (d) {
                                      return (
                                        Math.floor(cx(d.nonWhite_percent)) +
                                        "px"
                                      );
                                    })
                                    .style("top", function (d) {
                                  ...
                                  markerBubble
                                    ...
                                    .style("left", function (d) {
                                      return (
                                        Math.floor(
                                          cx(exampleFilm.nonWhite_percent),
                                        ) -
                                        3 +
                                        "px"
                                      );
                                  ...
                                  previewData
                                    .data([
                                      exampleFilm.nonWhite_percent,
                                      1 - exampleFilm.nonWhite_percent,
                                    ])
                                    .enter();
                                  ...
                                  previewData
                                    .select(".histogram-two-data-preview-bar")
                                    .transition()
                                    .duration(200)
                                    .style("width", function (d) {
                                  ...
                                  whiteForty
                                    ...
                                    .delay(delayAmount)
                                    .style("opacity", 1)
                                    .style("left", 900 * 0.4 + "px");
                                  whiteTen
                                    .transition()
                                    .duration(durationAmount)
                                    .delay(delayAmount)
                                    .style("opacity", 1)
                                    .style("left", 900 * 0.1 + "px");
                                  whiteTwentyFive
                                    .transition()
                                    .duration(durationAmount)
                                    .delay(delayAmount)
                                    .style("opacity", 1)
                                    .style("left", 900 * 0.25 + "px");
                                  nonWhiteSixty
                                    .transition()
                                    .duration(durationAmount)
                                    .delay(delayAmount)
                                    .style("opacity", 1)
                                    .style("left", 900 * 0.6 + "px");
                                  midPoint
                                    .transition()
                                    .duration(durationAmount)
                                    .delay(delayAmount)
                                    .style("left", 900 * 0.5 + "px");
                                }
                              } else {
                              }
                            })
                        ...
                        function updateSpectrumSearch(data) {
                          ...
                          if (stage == 3) {
                            ...
                            markerFixed
                              ...
                              .style(
                                "left",
                                axisSize(data.nonWhite_percent) + "px",
                              );
                            previewNameContainerFixed
                              .transition()
                              .duration(250)
                            ...
                            var element = filmElements.filter(function (d, i) {
                              return data.script_id == d.script_id;
                            });
                            previewName.text(data.title);
                            previewData
                              .data([
                                data.nonWhite_percent,
                                1 - data.nonWhite_percent,
                              ])
                              .enter();

                            previewData
                              .select(".histogram-two-data-preview-percent")
                              .text(function (d, i) {
                                return percentFormat(d);
                              });
                            ...
                            var leftPosition = +element
                              .style("left")
                              .replace("px", "");
                            var topPosition = +element
                              .style("top")
                              .replace("px", "");
                            if (mobile) {
                              markerBubble
                                .style("left", leftPosition - 3 + "px")
                                .transition()
                                .duration(100)
                                .style("opacity", 1);
                              markerBubble
                                .style(
                                  "top",
                                  topPosition + markerBubbleTopOffset + "px",
                                )
                                .transition()
                                .duration(100)
                                .style("opacity", 1);
                              previewNameContainer.style(
                                "top",
                                topPosition + previewTopOffset + "px",
                              );
                              if (leftPosition < 100) {
                                previewNameContainer.style(
                                  "left",
                        ...
                        function updateSpectrum(id) {
                          ...
                          if (stage == 3) {
                            ...
                            var changeMovieLinesData = filmElements.filter(
                              function (d, i) {
                                return i == 0;
                              },
                            );
                        ...
                        function adjustAxis(genre) {
                          ...
                          if (genre == "all") {
                            nonWhiteTop
                              ...
                              .delay(delayAmount)
                              .style("opacity", 1)
                              .style("left", filmElements.size() - 1 + "px");
                            whiteTop
                              .transition()
                              .duration(durationAmount)
                              .delay(delayAmount)
                            ...
                            whiteForty
                              ...
                              .delay(delayAmount)
                              .style("opacity", 1)
                              .style("left", axisSize(0.4) + "px");
                            whiteTen
                              .transition()
                              .duration(durationAmount)
                              .delay(delayAmount)
                              .style("opacity", 1)
                              .style("left", axisSize(0.1) + "px");
                            whiteTwentyFive
                              .transition()
                              .duration(durationAmount)
                              .delay(delayAmount)
                              .style("opacity", 1)
                              .style("left", axisSize(0.25) + "px");
                            nonWhiteSixty
                              .transition()
                              .duration(durationAmount)
                              .delay(delayAmount)
                              .style("opacity", 1)
                              .style("left", axisSize(0.6) + "px");
                            midPoint
                              .transition()
                              .duration(durationAmount)
                              .delay(delayAmount)
                              .style("left", axisSize(0.5) + "px");
                            markerFixed
                              .transition()
                              .duration(durationAmount)
                              .delay(delayAmount)
                        ...
                        if (mobile) {
                          axisWidth = width;
                          d3.select(stageTwoElement).style(
                            "width",
                            width + "px",
                          );
                        }
                        ...
                        histogramTwoAxis = d3
                          .select(stageTwoElement)
                          .append("div")
                          .attr("class", "star-chart-axis");

                        var whiteTop = histogramTwoAxis
                          .append("div")
                          .style("left", "0%")
                        ...
                        var nonWhiteTop = histogramTwoAxis
                          .append("div")
                          .style("left", axisWidth - 1 + "px")
                          .attr("class", "histogram-two-axis-tick")
                          .style("border-color", nonWhiteColor);
                        var yAxisHistogramTwo = histogramTwoAxis
                          .append("div")
                        ...
                        var whiteTenText = whiteTen
                          ...
                          .attr("class", "histogram-two-axis-text tk-futura-pt")
                          .html("<br>90%");
                        var whiteTwentyFive = histogramTwoAxis
                          .append("div")
                          .style("left", axisWidth * 0.25 + "px")
                          .attr("class", "histogram-two-axis-tick")
                          .style("border-color", whiteColor);
                        ...
                        var whiteTwentyFiveText = whiteTwentyFive
                          ...
                          .attr("class", "histogram-two-axis-text tk-futura-pt")
                          .html("<br>75%");
                        var whiteForty = histogramTwoAxis
                          .append("div")
                          .style("left", axisWidth * 0.4 + "px")
                          .attr("class", "histogram-two-axis-tick")
                          .style("border-color", whiteColor);
                        ...
                        var midPointText = midPoint
                          ...
                          .attr(
                            "class",
                            "histogram-two-axis-text histogram-two-axis-mid tk-futura-pt",
                          )
                          .html("50/50<br>Race Split");
                        var nonWhiteSixty = histogramTwoAxis
                          .append("div")
                          .style("left", axisWidth * 0.6 + "px")
                          .attr("class", "histogram-two-axis-tick")
                          .style("border-color", nonWhiteColor);
                        ...
                        var previewNameContainerFixed = d3
                          .select(".star-chart-axis")
                          .append("div")
                          .attr(
                            "class",
                            "histogram-two-name-container-fixed tk-futura-pt",
                          );
                        var previewNameContainer = d3
                          .select(".star-chart-axis")
                          .append("div")
                          .attr(
                            "class",
                            "histogram-two-name-container tk-futura-pt",
                          );
                        var previewNameFixed = previewNameContainerFixed
                          .append("div")
                          .attr(
                            "class",
                            "histogram-two-name-fixed tk-futura-pt",
                          )
                          .style("color", "rgb(0, 0, 0)")
                          .text("The Truman Show");
                        var previewName = previewNameContainer
                          .append("div")
                        ...
                        var previewDataBarScale = d3.scale
                          .linear()
                          .domain([0, 1])
                          .range([0, 50]);
                        ...
                        var previewData = previewNameContainer
                          ...
                          .attr(
                            "class",
                            "histogram-two-data-preview tk-futura-pt",
                          )
                          .selectAll("div")
                        ...
                        if (!mobile) {
                          var previewDataLabel = previewData
                            .append("p")
                            .attr(
                              "class",
                              "histogram-two-data-preview-label tk-futura-pt",
                            )
                            .text(function (d, i) {
                              if (i == 0) {
                        ...
                        if (mobile) {
                          previewDataLabel = previewData
                            .append("p")
                            .attr(
                              "class",
                              "histogram-two-data-preview-label-mobile tk-futura-pt",
                            )
                            .text(function (d, i) {
                              if (i == 0) {
                                return "nonwhite words";
                        ...
                        var previewDataBar = previewData
                          .append("div")
                        ...
                        var previewDataPercent = previewData
                          .append("p")
                          .attr(
                            "class",
                            "histogram-two-data-preview-percent tk-futura-pt",
                          )
                          .text(function (d, i) {
                            return percentFormat(d);
                          });
                        ...
                        function changeMovieLines(data) {
                          ...
                          var scriptLinesContainer = d3
                            .select(stageTwoElement)
                            .append("div")
                            .attr(
                              "class",
                              "histogram-two-script-container tk-futura-pt",
                            );
                          ...
                          var scriptLinesPercentContainer = scriptLinesTitle
                            .append("div")
                            .attr("class", "script-lines-title-sub");
                          scriptLinesPercentContainer
                            .append("p")
                            .html(function (d) {
                              var percent =
                                "<span style='color:" +
                                whiteColor +
                                ";'>" +
                                percentFormat(1 - data.nonWhite_percent) +
                                " White</span>/<span style='color:" +
                                nonWhiteColor +
                                ";'>" +
                                percentFormat(data.nonWhite_percent) +
                                " Nonwhite</span>";
                              return percent;
                            })
                          ...
                          var startLabel = scriptLinesDataLines
                            ...
                            .style("height", function (d, i) {
                              var height =
                                barHeight / 2 - ((d[0] / 14) * barHeight) / 2;
                              return height + "px";
                            })
                            .append("p")
                            .attr(
                          ...
                          var midLabel = scriptLinesDataLines
                            ...
                            .text(function (d) {
                              ...
                              return (
                                ordinal_suffix_of(num) + " MINUTE OF DIALOGUE"
                              );
                            })
                            .style("bottom", "-34px")
                          ...
                          scriptLines
                            ...
                            .attr(
                              "class",
                              "histogram-two-script-data-label tk-futura-pt",
                            )
                            .style("color", whiteColor)
                          ...
                          var peopleList = characterMap.get(
                            data.script_id,
                          ).values;
                          ...
                          var scriptLinesCast = scriptLinesCastContainer
                            .selectAll("div")
                          ...
                          scriptLinesCast
                            ...
                            .text(function (d) {
                              if (d.imdb_character_name.length > 14) {
                                return (
                                  d.imdb_character_name.slice(0, 12) + "..."
                                );
                              }
                        ...
                        d3.selectAll(".filter-item-spectrum").on(
                          "click",
                          function (d) {
                            var id = d3.select(this).attr("id");
                            d3.selectAll(".filter-item-spectrum")
                        ...
                        function searchSpectrum() {
                          ...
                          function searchFilmColumn(value) {
                            if (value.length > 2) {
                              ...
                              //
                              var searchDivData = searchResults
                                .selectAll("p")
                              ...
                              var searchEnter = searchDivData
                                ...
                                .html(function (d) {
                                  ...
                                  var percent =
                                    "<span class='search-result-percent'><span style='color:" +
                                    whiteColor +
                                    ";'>" +
                                    percentFormat(1 - d.nonWhite_percent) +
                                ...
                                .on("click", function (d) {
                                  ...
                                  d3.selectAll(".filter-item-spectrum")
                                    ...
                                    .style("border-color", null)
                                    .style("font-weight", null);
                                  d3.select(".filter-item-spectrum")
                                    .style("background-color", "#F5F5F5")
                                    .style(
                                      "box-shadow",
                                      "inset 0 3px 5px rgba(0,0,0,.125)",
                      ...
                      //         return percentFormat(1-d.nonWhite_percent) + " Lighter-skinned actor Lines"
                      //       }
                      //       else if (i==0 && d.nonWhite_percent > .6666665){
                      //         return percentFormat(d.nonWhite_percent) + " Darker-skinned actor Lines"
                      //       }
                      ...
                      function histogramThree() {
                        ...
                        var movieMap = movieData.map(function (d) {
                          return d.nonWhite_percent;
                        });
                        ...
                        var buckets = d3.layout
                          .histogram()
                          .bins([0, 0.1, 0.4, 0.6, 0.9, 1])(movieMap);

                        var maxBuckets = d3.max(buckets, function (d) {
                          return +d.y;
                        });
                        var bucketsScale = d3.scale
                          .linear()
                          .domain([0, movieMap.length])
                          .range([0, 400]);

                        var histogramThreeSpectrum = d3
                          .select(".histogram-three")
                          .append("div")
                        ...
                        d3.select(".histogram-three-spectrum-bucket").style(
                          "box-shadow",
                          "inset 0 3px 5px rgba(0,0,0,.125)",
                        );
                        ...
                        d3.select(".histogram-three")
                          ...
                          .html(
                            "Sorted by Films with <span class='histogram-three-highlight'>90%+</span> Light-skinned actor Lines ",
                          );
                        ...
                        d3.select(".histogram-three-spectrum")
                          ...
                          .attr(
                            "class",
                            "histogram-three-spectrum-title tk-futura-pt",
                          )
                        ...
                        d3.select(".histogram-three-spectrum")
                          ...
                          .attr(
                            "class",
                            "histogram-three-spectrum-white tk-futura-pt",
                          )
                          .style("color", whiteColor)
                        ...
                        d3.select(".histogram-three-spectrum")
                          ...
                          .attr(
                            "class",
                            "histogram-three-spectrum-nonWhite tk-futura-pt",
                          )
                          .style("color", nonWhiteColor)
                        ...
                        d3.select(".histogram-three-spectrum-data")
                          ...
                          .attr(
                            "class",
                            "histogram-three-spectrum-median tk-futura-pt",
                          )
                          .append("p")
                          .attr(
                            "class",
                            "histogram-three-spectrum-median-text tk-futura-pt",
                          )
                          .style("color", "rgb(78, 77, 77)")
                          .text("50/50");

                        var histogramThreeDiv = d3
                          .select(".histogram-three")
                          .append("div")
                        ...
                        histogramThreeData = histogramThreeData.sort(
                          function (a, b) {
                            var o1 = a.nonWhite_percent;
                            var o2 = b.nonWhite_percent;
                        ...
                        var histogramThreeRow = histogramThreeDiv
                          .selectAll("div")
                          .data(histogramThreeData)
                          .enter()
                          .append("div")
                          .attr("class", "histogram-three-row");
                        var rowText = histogramThreeRow
                          .append("p")
                          .attr(
                            "class",
                            "histogram-three-row-text tk-futura-pt",
                          )
                          .text(function (d) {
                        ...
                        var histogramThreeDot = histogramThreeRow
                          .append("div")
                        ...
                        d3.select(".histogram-three-row")
                          ...
                          .attr(
                            "class",
                            "histogram-three-axis histogram-three-axis-left",
                          )
                          .append("p")
                        ...
                        d3.select(".histogram-three-row")
                          ...
                          .attr(
                            "class",
                            "histogram-three-axis histogram-three-axis-center",
                          )
                          .append("p")
                          .attr("class", "histogram-three-text tk-futura-pt")
                          .html("50/50<br>Race Split");
                        ...
                        d3.select(".histogram-three-row")
                          ...
                          .attr(
                            "class",
                            "histogram-three-axis histogram-three-axis-right",
                          )
                          .style("left", null)
                          .append("p")
                          .attr("class", "histogram-three-text tk-futura-pt")
                      ...
                      function allFilms() {
                        ...
                        var sumBuckets = d3.sum(buckets, function (d) {
                          return +d.y;
                        });
                        var maxPercent = d3.max(buckets, function (d) {
                          return +(d.y / sumBuckets);
                        });
                        var scaleBarSize = d3.scale
                          .linear()
                          .domain([0, maxPercent])
                          .range([10, 200]);
                        // var bucketsScale = d3.scale.linear().domain([0,maxBuckets]).range([0,250])

                        var distributionColumnContainer = d3
                          .select(".all-films-distribution-container")
                          .append("div")
                          .attr(
                            "class",
                        ...
                        var distributionColumn = distributionColumnContainer
                          .append("div")
                        ...
                        var distributionBars = histogramThreeSpectrum
                          ...
                          .style("width", function (d) {
                            return (
                              distributionBarWidth * (d.y / sumBuckets) + "px"
                            );
                          });
                        ...
                        var filteredBucketData = movieData.filter(
                          function (d, i) {
                            return (
                              bucketScale(d.nonWhite_percent) == bucketSelected
                            );
                          },
                        );
                        var detailChart = d3
                          .select(".all-films-detail-data-container")
                          .append("div")
                          .attr("class", "all-films-detail-data");
                        var detailChartData = detailChart
                          .selectAll("div")
                          .data(
                            filteredBucketData.slice(0, 19),
                            function (d, i) {
                              return d.script_id;
                            },
                          );
                        function detailElementsDraw() {
                          ...
                          detailChartEnter
                            .on("mouseover", function (d, i) {
                                ...
                                detailChartData
                                  ...
                                  .style("width", function (d) {
                                    var totalWords = d3
                                      ...
                                      .datum().total_words;
                                    return (
                                      Math.ceil((100 * d.words) / totalWords) +
                                      "px"
                                    );
                                  })
                                  .style("background-color", function (d, i) {
                                    var filmnonWhitePercent = d3
                                      .select(this.parentNode)
                                      .datum().nonWhite_percent;
                                    if (d.race == "w") {
                                      return detailScalewhite(
                                        1 - filmnonWhitePercent,
                                      );
                                    }
                                    return detailScalenonWhite(
                                      filmnonWhitePercent,
                                    );
                                  })
                                  .style("left", function (d) {
                                    var totalWords = d3
                                      .select(this.parentNode)
                                      .datum().total_words;
                                    var offset = Math.ceil(
                                      (100 * d.offset) / totalWords,
                                    );
                                    return offset + "px";
                                  })
                                  .style("top", function (d, i) {
                              ...
                              detailToolTipRows
                                ...
                                .text(function (d) {
                                  if (
                                    +d.imdb_character_name.length >
                                    characterNameLength
                                  ) {
                                    return (
                                      d.imdb_character_name.slice(
                                        0,
                                        characterNameLength - 2,
                                      ) + "..."
                                    );
                                  }
                                  return d.imdb_character_name;
                          ...
                          var detailScalenonWhite = d3.scale
                            .linear()
                            .domain([0, 1])
                            .range(["#CCC", nonWhiteColor]);
                          var detailScalewhite = d3.scale
                            .linear()
                            .domain([0, 1])
                            .range(["#CCC", whiteColor]);
                          ...
                          detailChartDataTitle
                            ...
                            .attr(
                              "class",
                              "all-films-detail-film-cast-line-bar",
                            )
                            .style("width", function (d) {
                              var totalWords = d3
                                .select(this.parentNode)
                                .datum().total_words;
                              return (
                                Math.ceil((100 * d.words) / totalWords) + "px"
                              );
                            })
                            .style("background-color", function (d, i) {
                              var filmnonWhitePercent = d3
                        ...
                        var detailNext = d3
                          ...
                          .on("click", function () {
                            ...
                            detailChartData = detailChartData.data(
                              filteredBucketData.slice(
                                offsetAmount,
                                offsetAmount + 19,
                              ),
                              function (d, i) {
                        ...
                        if (
                          ...
                          detailToolTipRows = detailToolTip
                            ...
                            .data(
                              characterMap.get(
                                filteredBucketData.slice(0, 1)[0].script_id,
                              ).values,
                            )
                            .enter()
                            .append("div")
                          ...
                          var detailToolTipLines = detailToolTipRows
                            ...
                            .style("margin-right", function (d) {
                              var totalWords = filteredBucketData.slice(0, 1)[0]
                                .total_words;
                              return 100 * (d.words / totalWords) + "px";
                            });
                        ...
                        var detailToolTipNames = detailToolTipRows
                          ...
                          .text(function (d) {
                            if (
                              d.imdb_character_name.length > characterNameLength
                            ) {
                              return (
                                d.imdb_character_name.slice(
                                  0,
                        ...
                        function searchSpectrum() {
                          ...
                          function searchFilmColumn(value) {
                            ...
                            if (value.length > 2) {
                              ...
                              filteredBucketData = movieData.filter(
                                function (d, i) {
                                  var string = d.genreList;
                                  if (
                                    genreSelectedAll == "all" &&
                                    eraSelected == "all"
                                  ) {
                                    ...
                                    return (
                                      string.indexOf(genreSelectedAll) > -1 &&
                                      re.test(d["title"])
                                    );
                                  }
                                  return (
                        ...
                        function resetToolTip() {
                          ...
                          if (
                            ...
                            var topMovie = d3
                              .selectAll(".all-films-detail-film")
                              .filter(function (d, i) {
                                return i == 0;
                              })
                              .data();
                            detailToolTipRows = d3
                              ...
                              .selectAll("div")
                              .data(
                                characterMap.get(topMovie[0].script_id).values,
                              )
                              .enter()
                              .append("div")
                              .sort(function (a, b) {
                            ...
                            detailToolTipRows
                              ...
                              .style("margin-right", function (d) {
                                var totalWords = filteredBucketData.slice(
                                  0,
                                  1,
                                )[0].total_words;
                                return 100 * (d.words / totalWords) + "px";
                        ...
                        function distributionUpdate() {
                          ...
                          var movieMap = filteredBucketData.map(function (d) {
                            return d.nonWhite_percent;
                          });
                          ...
                          sumBuckets = d3.sum(buckets, function (d) {
                            return +d.y;
                          });
                          var maxPercent = d3.max(buckets, function (d) {
                            return +(d.y / sumBuckets);
                          ...
                          histogramThreeSpectrum =
                            histogramThreeSpectrum.data(buckets);
                          ...
                          filteredBucketData = movieData.filter(
                            function (d, i) {
                              ...
                              if (
                                ...
                                return (
                                  bucketScale(d.nonWhite_percent) ==
                                  bucketSelected
                                );
                              } else if (
                                genreSelectedAll == "all" &&
                        ...
                        d3.selectAll(".all-films-distribution-bucket").on(
                          "click",
                          function (d, i) {
                            offsetAmount = 0;
                            ...
                            if (bucketPrevious != bucketsMap[i]) {
                              ...
                              d3.selectAll(".all-films-distribution-bucket")
                                .style("background-color", null)
                                .select(".all-films-distribution-check")
                                .select("input")
                        ...
                        d3.selectAll(".filter-item-all").on(
                          "click",
                          function (d, i) {
                            offsetAmount = 0;
                        ...
                        d3.selectAll(".filter-item-era").on(
                          "click",
                          function (d, i) {
                            offsetAmount = 0;
                      ...
                      function ageHistogram() {
                        ...
                        for (var raceBucket in ageNest) {
                          ...
                          if (ageNest[raceBucket].key != "?") {
                            ...
                            var totalSum = d3.sum(buckets, function (d) {
                              return d.total;
                            });
                            var extent = d3.extent(buckets, function (d) {
                              return d.total / totalSum;
                            });

                            var bucketText = [
                              "Under 21<br>years-old",
                              "22 to 31",
                              "32 to 41",
                              "42 to 65",
                              "65+<br>years-old",
                            ...
                            var bucketsScale = d3.scale
                              ...
                              .domain([0, 1])
                              .range([0, 300]);
                            var bucketsColorScale = d3.scale
                              .linear()
                              .domain(extent)
                              .range([0.35, 1]);
                            ...
                            var ageDataHistogram = ageContainer
                              .append("div")
                            ...
                            var agePercent = ageDataHistogram
                              ...
                              .text(function (d, i) {
                                ...
                                if (i == 0) {
                                  return (
                                    percentFormat(d.total / totalSum) +
                                    " of All " +
                                    textrace +
                                    " Dialogue in Dataset"
                                  );
                        ...
                        var ageChart = ageChartContainer
                          .append("svg")
                        ...
                        var area = d3.svg
                          ...
                          .y0(height)
                          .y1(function (d) {
                            return y(d.values / ageMax[d.raceTag]);
                          });
                      ...
                      var xGroup = grossChart
                        ...
                        .attr(
                          "transform",
                          "translate(0," + testHeight * 0.95 + ")",
                        )
                        .attr(
                          "class",
                          "age-chart-distribution-percent tk-futura-pt",
                        )
                        .call(customXAxis);
                      ...
                      var xSeries = usGross.map(function (d) {
                        return parseFloat(d.pct_wht);
                      });
                      ...
                      function leastSquares(xSeries, ySeries) {
                        ...
                        var xBar =
                          (xSeries.reduce(reduceSumFunc) * 1.0) /
                          xSeries.length;
                        var yBar =
                          (ySeries.reduce(reduceSumFunc) * 1.0) /
                          ySeries.length;
                      ...
                      function handleResize() {
                        ...
                        if (!mobile) {
                          xShift = Math.floor(
                            (window.innerWidth - testWidth) / 2,
                          );
                          yShift = -30;
                        } else {
                          xShift =
                            Math.floor((window.innerWidth - testWidth) / 2) - 7;
                          yShift = -30;
                        }
